...
hourTime = tk.Entry(clock, textvariable = hour, bg = "pink", width = 15).place(x=110,y=100)
...
submit = tk.Button(clock,text = "Set Alarm",fg="red",width = 10,command = set_alarm_clock).place(x =110,y=140)
